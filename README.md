...
- DESeq_output_FFPE_T_vs_urines_T.zip (https://github.com/MorillonLab/Prostate_6_tumor_FFPE_vs_6_tumor_uEVs_analysis/blob/main/DESeq_output_FFPE_T_vs_urines_T.zip) : differential expression table from DESeq2 between 6 tumor FFPE & 6 paired tumor uEVs

- Read counts from gencode32 + repeats + circRNAs (from 6 FFPE & 6 paired uEVs tumor samples) : 
