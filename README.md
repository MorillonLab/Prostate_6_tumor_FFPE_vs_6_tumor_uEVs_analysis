...
- Intersection between different annotations of circRNAs (there are 8 tables, and the annotations are in gff3 format ; the 9th column, gives useful informations about the circRNA) :
